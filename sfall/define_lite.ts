...
export const FLOAT_MSG_WARNING = -2;
export const FLOAT_MSG_SEQUENTIAL = -1;
export const FLOAT_MSG_NORMAL = 0;
export const FLOAT_MSG_BLACK = 1;
export const FLOAT_MSG_RED = 2;
export const FLOAT_MSG_GREEN = 3;
export const FLOAT_MSG_BLUE = 4;
export const FLOAT_MSG_PURPLE = 5;
export const FLOAT_MSG_NEAR_WHITE = 6;
export const FLOAT_MSG_LIGHT_RED = 7;
export const FLOAT_MSG_YELLOW = 8;
export const FLOAT_MSG_WHITE = 9;
export const FLOAT_MSG_GREY = 10;
export const FLOAT_MSG_DARK_GREY = 11;
export const FLOAT_MSG_LIGHT_GREY = 12;
...
export const TRAIT_PERK = 0;
export const TRAIT_OBJECT = 1;
export const TRAIT_TRAIT = 2;
export const PERK_bonus_awareness = 0;
export const PERK_bonus_hth_attacks = 1;
export const PERK_bonus_hth_damage = 2;
export const PERK_bonus_move = 3;
export const PERK_bonus_ranged_damage = 4;
export const PERK_bonus_rate_of_fire = 5;
export const PERK_earlier_sequence = 6;
export const PERK_faster_healing = 7;
export const PERK_more_criticals = 8;
export const PERK_night_vision = 9;
export const PERK_presence = 10;
export const PERK_rad_resistance = 11;
export const PERK_toughness = 12;
export const PERK_strong_back = 13;
export const PERK_sharpshooter = 14;
export const PERK_silent_running = 15;
export const PERK_survivalist = 16;
export const PERK_master_trader = 17;
export const PERK_educated = 18;
export const PERK_healer = 19;
export const PERK_fortune_finder = 20;
export const PERK_better_criticals = 21;
export const PERK_empathy = 22;
export const PERK_slayer = 23;
export const PERK_sniper = 24;
export const PERK_silent_death = 25;
export const PERK_action_boy = 26;
/** -- Disabled FO2 */
export const PERK_mental_block = 27;
export const PERK_lifegiver = 28;
export const PERK_dodger = 29;
export const PERK_snakeater = 30;
export const PERK_mr_fixit = 31;
export const PERK_medic = 32;
export const PERK_master_thief = 33;
export const PERK_speaker = 34;
export const PERK_heave_ho = 35;
/** -- Disabled FO2 */
export const PERK_friendly_foe = 36;
export const PERK_pickpocket = 37;
export const PERK_ghost = 38;
export const PERK_cult_of_personality = 39;
/** -- Disabled FO2 */
export const PERK_scrounger = 40;
export const PERK_explorer = 41;
/** -- Disabled FO2 */
export const PERK_flower_child = 42;
export const PERK_pathfinder = 43;
/** -- Disabled FO2 */
export const PERK_animal_friend = 44;
export const PERK_scout = 45;
export const PERK_mysterious_stranger = 46;
export const PERK_ranger = 47;
export const PERK_quick_pockets = 48;
export const PERK_smooth_talker = 49;
export const PERK_swift_learner = 50;
export const PERK_tag = 51;
export const PERK_mutate = 52;
...
export const PERK_gecko_skinning_perk = 73;
export const PERK_dermal_armor_perk = 74;
export const PERK_dermal_enhancement_perk = 75;
export const PERK_phoenix_armor_perk = 76;
export const PERK_phoenix_enhancement_perk = 77;
export const PERK_vault_city_inoculations_perk = 78;
export const PERK_adrenaline_rush_perk = 79;
export const PERK_cautious_nature_perk = 80;
export const PERK_comprehension_perk = 81;
export const PERK_demolition_expert_perk = 82;
export const PERK_gambler_perk = 83;
export const PERK_gain_strength_perk = 84;
export const PERK_gain_perception_perk = 85;
export const PERK_gain_endurance_perk = 86;
export const PERK_gain_charisma_perk = 87;
export const PERK_gain_intelligence_perk = 88;
export const PERK_gain_agility_perk = 89;
export const PERK_gain_luck_perk = 90;
export const PERK_harmless_perk = 91;
export const PERK_here_and_now_perk = 92;
export const PERK_hth_evade_perk = 93;
export const PERK_kama_sutra_perk = 94;
export const PERK_karma_beacon_perk = 95;
export const PERK_light_step_perk = 96;
export const PERK_living_anatomy_perk = 97;
export const PERK_magnetic_personality_perk = 98;
export const PERK_negotiator_perk = 99;
export const PERK_pack_rat_perk = 100;
export const PERK_pyromaniac_perk = 101;
export const PERK_quick_recovery_perk = 102;
export const PERK_salesman_perk = 103;
export const PERK_stonewall_perk = 104;
export const PERK_thief_perk = 105;
export const PERK_weapon_handling_perk = 106;
export const PERK_vault_city_training_perk = 107;
export const PERK_alcohol_hp_bonus1_perk = 108;
export const PERK_alcohol_hp_bonus2_perk = 109;
export const PERK_alcohol_hp_neg1_perk = 110;
export const PERK_alcohol_hp_neg2_perk = 111;
export const PERK_autodoc_hp_bonus1_perk = 112;
export const PERK_autodoc_hp_bonus2_perk = 113;
export const PERK_autodoc_hp_neg1_perk = 114;
export const PERK_autodoc_hp_neg2_perk = 115;
export const PERK_expert_excrement_expediter_perk = 116;
export const PERK_weapon_knockout_perk = 117;
export const PERK_jinxed_perk = 118;
...
export const TRAIT_fast_metabolism = 0;
export const TRAIT_bruiser = 1;
export const TRAIT_small_frame = 2;
export const TRAIT_one_hander = 3;
export const TRAIT_finesse = 4;
export const TRAIT_kamikaze = 5;
export const TRAIT_heavy_handed = 6;
export const TRAIT_fast_shot = 7;
export const TRAIT_bloody_mess = 8;
export const TRAIT_jinxed = 9;
export const TRAIT_good_natured = 10;
export const TRAIT_drug_addict = 11;
export const TRAIT_drug_resistant = 12;
export const TRAIT_sex_appeal = 13;
export const TRAIT_skilled = 14;
export const TRAIT_gifted = 15;
export const STAT_st = 0;
export const STAT_pe = 1;
export const STAT_en = 2;
export const STAT_ch = 3;
export const STAT_iq = 4;
export const STAT_ag = 5;
export const STAT_lu = 6;
export const STAT_max_hp = 7;
export const STAT_max_hit_points = 7;
export const STAT_max_move_points = 8;
export const STAT_ac = 9;
/** used in sfall for critter inventory size (see CritterInvSizeLimitMode) */
export const STAT_unused = 10;
export const STAT_melee_dmg = 11;
export const STAT_carry_amt = 12;
export const STAT_sequence = 13;
export const STAT_heal_rate = 14;
export const STAT_crit_chance = 15;
export const STAT_better_crit = 16;
export const STAT_dmg_thresh = 17;
export const STAT_dmg_thresh_laser = 18;
export const STAT_dmg_thresh_fire = 19;
export const STAT_dmg_thresh_plasma = 20;
export const STAT_dmg_thresh_electrical = 21;
export const STAT_dmg_thresh_emp = 22;
export const STAT_dmg_thresh_explosion = 23;
export const STAT_dmg_resist = 24;
export const STAT_dmg_resist_laser = 25;
export const STAT_dmg_resist_fire = 26;
export const STAT_dmg_resist_plasma = 27;
export const STAT_dmg_resist_electrical = 28;
export const STAT_dmg_resist_emp = 29;
export const STAT_dmg_resist_explosion = 30;
export const STAT_rad_resist = 31;
export const STAT_poison_resist = 32;
export const STAT_age = 33;
export const STAT_gender = 34;
export const STAT_current_hp = 35;
export const STAT_current_poison = 36;
export const STAT_current_rad = 37;
export const STAT_real_max_stat = 38;
export const PCSTAT_unspent_skill_points = 0;
export const PCSTAT_level = 1;
export const PCSTAT_experience = 2;
export const PCSTAT_reputation = 3;
export const PCSTAT_karma = 4;
export const PCSTAT_max_pc_stat = 5;
...
export const CRITTER_IS_NORMAL = 0;
export const CRITTER_IS_DEAD = 1;
export const CRITTER_IS_PRONE = 2;
export const INVEN_TYPE_WORN = 0;
export const INVEN_TYPE_RIGHT_HAND = 1;
export const INVEN_TYPE_LEFT_HAND = 2;
export const INVEN_TYPE_INV_COUNT = -2;
...
export const DMG_normal_dam = 0;
export const DMG_laser = 1;
export const DMG_fire = 2;
export const DMG_plasma = 3;
export const DMG_electrical = 4;
export const DMG_emp = 5;
export const DMG_explosion = 6;
...
export const ROLL_CRITICAL_FAILURE = 0;
export const ROLL_FAILURE = 1;
export const ROLL_SUCCESS = 2;
export const ROLL_CRITICAL_SUCCESS = 3;
...
/** @inline */
export function is_skill_tagged(skill: number): number {
